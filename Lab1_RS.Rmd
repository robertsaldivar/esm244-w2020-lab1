...
Find annualy total US landings and dollar value (dumming across all states) for each TYPE of salmon using 'group_by()' + 'summarize()'
...
kable(salmon_first_5) %>%
  kable_styling(boostrap_options = striped, full_width = FALSE) #Check the kable styling to understand what is going on.
```
